...
<?php require_once 'Includes/mainHeader.php'; ?>                     
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php">Home</a><i class="fa fa-angle-right"></i>Teams <i class="fa fa-angle-right"></i> Add User Team</li>
                    </ol>
                        ...
                        <div class="grid-form1">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="horizontal-form">
                                    <form class="form-horizontal" action="process/processAddUserTeams.php" method="post">
                                                ...
                                                <select name="user" class="form-control">
                                                    ...
                                                    <?php 
                                                        ...
                                                        foreach ($users as $user): ?>
                                                            <option value="<?php echo trim($user['id']); ?>"><?php echo trim($user['first_name'] . " " . $user['last_name']); ?></option>
                                                    <?php 
                                                        endforeach;  
                                                        }else{ ?>
                                ...
                                <div class="panel-footer">
                                    <div class="row">
                                        <div class="col-sm-8 col-sm-offset-2">
                                            <button class="btn-primary btn">Add User Team</button>
                                        </div>
                                    </div>
                                </div>
